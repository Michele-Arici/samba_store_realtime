...
if (email != null) {
    ...
    ownedRef.once("value", (snap) => {
        ...
        if (item_temp != null) {
            ...
            const empty_div = `<div class="empty">
                ...
                <p class="empty-subtitle text-muted">You have currently didn't bought any tracks</p>
            </div>`;
            document.getElementById('result_div').innerHTML = empty_div;
        }
